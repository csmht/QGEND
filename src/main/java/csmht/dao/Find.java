...
public class Find {
    ...
    static public Post FindPost(Connection con,String key0,String value0,String sort) throws SQLException, IOException, InterruptedException {
        ...
        if(rs.next()){
            ...
            post.setLikes(csmht.dao.JedisTool.FindLikesPost(""+post.getPost_id()));

            post.setViews(csmht.dao.JedisTool.FindPostView("" + post.getUser_id()));

            post.setCreate_time(rs.getString("create_time"));
            post.setNew_time(rs.getString("new_time"));
...
//            user.setPassword(rs.getString("password"));
     ...
     * @throws SQLException
     */
    static public List<Comment> FindComment(Connection con, String key0, String value0, String sort) throws SQLException, InterruptedException, ParseException {
        ...
        while (rs.next()){
            ...
            one.setLikes(csmht.dao.JedisTool.FindCommentLike(one.getComment_Id()+""));
